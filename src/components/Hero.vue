<template>
  <div class="heroBlock"><!--makes loop and key fades and script adds texts on top with images-->
    <v-carousel cycle hide-delimiters>
      ...
      </v-carousel-item><!-- fill-height hidden-xs-only hides title if device is 600 px or less-->
    </v-carousel>
  </div>
</template>
