<template>
  <v-content>
    <div class="staticHero">
      <v-img src="../assets/images/img13.jpg"><!--regular img component-->
    ...
    <div class="block">
      <v-container>
        ...
        <v-row>
          <v-col v-for="item in items" :key="item.id" class="d-flex child-flex" cols="12" sm="4"><!--loop thru and display all-->
            <v-card flat tile class="mx-auto"><!--Card component-->
